										...
										<TABLE cellSpacing=0 cellPadding=2 border=0>
											<TBODY>
												<TR>
													<TD>拜访时间 从：</TD>
													<TD>
														<s:textfield theme="simple" class="textbox" id="sChannel2" cssStyle="WIDTH:80px" maxLength="50" name="visit_time"/>
													</TD>
													<TD>到：</TD>
													<TD>
														<s:textfield theme="simple" class="textbox" id="sChannel2" cssStyle="WIDTH:80px" maxLength="50" name="visit_end_time"/>
													</TD>
											...
											<TBODY>
												...
												<s:iterator value="list">
													<TR
														...
														<TD><s:date name="visit_time" format="yyyy-MM-dd" />
														</TD>
														<TD><s:property value="visit_addr" /></TD>
														<TD><s:property value="visit_detail" /></TD>
														<TD><s:date name="visit_nexttime" format="yyyy-MM-dd" />
														</TD>
														<TD><a href="${pageContext.request.contextPath }/saleVisit_edit.action?visit_id=<s:property value="visit_id"/>">修改</a>
															&nbsp;&nbsp; <a
															href="${pageContext.request.contextPath }/saleVisit_delete.action?visit_id=<s:property value="visit_id"/>">删除</a></TD>
													</TR>
												</s:iterator>
											</TBODY>
										</TABLE>
